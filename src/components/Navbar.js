  ...
  return (
    <nav className='bg-layout1 md:flex md:items-center md:min-h-32 md:absolute md:opacity-80 z-50 w-full '>
      <div className='mx-auto px-2 sm:px-6 lg:px-8 '>
        <div className='relative flex h-20 items-center '>
          <div className='absolute inset-y-0 left-0 flex items-center lg:hidden'>
            <button
              ...
              className='relative inline-flex items-center justify-center rounded-md p-2 text-text2 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-text2'
            ...
            <div className=' 2xl:mr-64'>
              ...
              >
                <StaticImage
                  ...
                  src='../../images/logo.jpg'
                />
                <span className=' text-text2 md:text-3xl ml-2 font-oswald'>
                  KARATE KLUB ŽIRI
                </span>
              </Link>
            </div>
            ...
            <div className='hidden md:ml-6 lg:block text-xl '>
              <div className='flex space-x-5  xl:space-x-14 2xl-space-x-32'>
                <Link
                  to='/'
                  className={`${
                    pathname === '/' ? 'text-identifier' : 'text-text2'
                ...
                <Link
                  to='/programi'
                  className={`${
                    pathname === '/programi/' ? 'text-identifier' : 'text-text2'
                  }   hover:text-identifier py-2 transition-all duration-300 ease-in-out  font-oswald tracking-wider `}
                >
                  PROGRAMI
                </Link>
                <Link
                  to='/galerija'
                  className={`${
                    pathname === '/galerija/' ? 'text-identifier' : 'text-text2'
                  }   hover:text-identifier  py-2 transition-all duration-300 ease-in-out  font-oswald tracking-wider `}
                >
                  GALERIJA
                </Link>
                ...
                <Link
                  to='/trenerji'
                  className={`${
                    pathname === '/trenerji/' ? 'text-identifier' : 'text-text2'
                  }   hover:text-identifier  py-2 transition-all duration-300 ease-in-out  font-oswald tracking-wider `}
                >
                  TRENERJI
                </Link>
                <Link
                  to='/vpis'
                  className={`${
                    pathname === '/vpis/' ? 'text-identifier' : 'text-text2'
        ...
        {/* Mobile menu */}
        {isMobileMenuOpen && (
          <div className={` inset-x-0 top-20 bg-layout1 transition-transform duration-300 ease-out z-10 ${
