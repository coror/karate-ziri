          ...
          <div className='relative flex h-20 items-center justify-between'>
            ...
            >
              <StaticImage
                ...
                src='../../images/logo.jpg'
              />
              <span className='text-text2 ml-2 font-oswald text-lg md:text-2xl'>
                KARATE KLUB ŽIRI
              </span>
            </Link>
                  ...
                  return (
                    <Link
                      ...
                      className={`group relative py-2 transition-colors duration-200 font-oswald tracking-wider text-lg ${
                        active ? 'text-identifier' : 'text-text2 hover:text-identifier'
                      }`}
                    >
                      {link.label}
                      <span
            ...
            <button
              type='button'
              className='lg:hidden relative z-50 w-10 h-10 flex items-center justify-center text-text2 focus:outline-none'
        ...
        <div className='relative h-full flex flex-col items-center justify-center space-y-7 px-6'>
          {navLinks.map((link, idx) => (
            <Link
              ...
              onClick={() => setIsMobileMenuOpen(false)}
              className={`${
                isActive(link.to) ? 'text-identifier' : 'text-text2'
