...
const Header = () => {
  return (
    <div className='w-auto max-h-screen md:h-screen overflow-hidden relative'>
      <div className='absolute top-[50%] 2xl:top-[50%]  right-1/2  -translate-x-1/2 -translate-y-1/2 px-8 text-center text-text2 animate-fade-left animate-delay-1000 z-10 lg:mx-[170px] '>
