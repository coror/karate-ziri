...
const Footer = () => {
  return (
    <footer className='relative bg-layout1 text-text2 font-oswald overflow-hidden'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-start'>
          <div className='md:col-span-5 flex flex-col items-center md:items-start text-center md:text-left'>
            ...
            <div className='flex gap-3'>
              <a
                href='https://www.facebook.com/karateklubziri'
                target='_blank'
                rel='noreferrer'
                aria-label='Facebook'
                className='w-10 h-10 rounded-full border border-text2/30 flex items-center justify-center hover:bg-identifier hover:border-identifier hover:text-text1 transition-all duration-300'
              >
                <FaFacebookF />
              </a>
              <a
          ...
          <div className='md:col-span-3 text-center md:text-left space-y-1 text-text2/80'>
            <p className='text-text2 text-lg mb-1'>Karate klub Žiri</p>
