...
const ContactLine = () => {
  return (
    <div className='flex-col md:flex-row bg-[#1A2930] flex text-white py-10 font-oswald'>
      {/* Phone */}
      <div className='text-center flex-1 relative' style={{ display: 'grid' }}>
        ...
        >
          <div className='text-center'>
            <p className=' text-[#f4ab04]'>POKLIČITE NAS NA</p>
      ...
      <div className='text-center flex-1 relative' style={{ display: 'grid' }}>
        ...
        >
          <div className='special-heading text-center'>
            <p className='text-[#f4ab04]'>JOBSTOVA CESTA 22</p>
      ...
      <div className='text-center flex-1 relative' style={{ display: 'grid' }}>
        ...
        >
          <div className='special-heading text-center'>
            <p className='text-[#f4ab04]'>DELOVNE URE</p>
