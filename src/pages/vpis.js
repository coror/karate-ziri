...
const inputBase =
  'px-4 py-3 bg-white border-2 focus:outline-none transition-colors duration-200';
      ...
      <div className='-mt-20 font-oswald'>
        ...
        <div className='bg-layout2 text-text1 py-16 md:py-24'>
          ...
          >
            ...
            >
              <div className='flex flex-col gap-1 mt-1'>
                <RadioOption
                  ...
                  label='Karate otroci in mladostniki'
                  checked={fields.tecaj === 'karate_mladostniki_ziri'}
                  onChange={handleChange}
                />
                <RadioOption
                  id='odrasli'
                  ...
                  label='Karate odrasli'
                  checked={fields.tecaj === 'karate_odrasli_ziri'}
                  onChange={handleChange}
                />
              </div>
            </Field>
              ...
              >
                <div className='flex flex-col gap-1 mt-1'>
                  <RadioOption
                    ...
                    name='obisk'
                    value='3x'
                    label='3x ali več (kombinacija s kickboxom)'
                    checked={fields.obisk === '3x'}
                    onChange={handleChange}
                  />
                  <RadioOption
                    id='2x'
            ...
            <Field
              label='Dovoljujem, da se izpolnjeni podatki in podatki o mojih tekmovalnih uspehih ter fotografije s tekmovanj ali treningov uporabljajo za potrebe, Karate kluba Kolektor Idrija, Karate kluba Cerkno ali Karate kluba Žiri.'
              htmlFor='dovoljenje'
              required
            ...
            <div className='mt-10 text-center'>
              <button
                type='submit'
                disabled={loading}
                className='inline-flex items-center justify-center min-w-[12rem] bg-identifier border-2 border-identifier py-3 px-8 text-lg lg:text-xl text-text2 cursor-pointer hover:text-identifier hover:bg-transparent transition-colors duration-200 ease-in-out tracking-wider disabled:opacity-60 disabled:cursor-not-allowed'
              >
                {loading ? (
            ...
            {submissionSuccess && formValid && (
              <p className='text-emerald-600 mt-4 text-center font-semibold'>
