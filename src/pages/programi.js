              ...
              <div className='flex 2xl:flex-row flex-col'>
                <div className='relative max-w-[60rem] md:mt-10 mb-10'>
                  <StaticImage
                    ...
                    alt='prijazna-sola'
                    className='max-w-[60rem] h-auto rounded-sm shadow-lg filter brightness-90 contrast-125  animate-fade-right animate-duration-1000 animate-delay-1000'
                  />
                </div>
                <div className='md:mt-10 flex flex-col items-center 2xl:block  animate-fade-right animate-duration-1000 animate-delay-1500'>
                  ...
                  <p className='max-w-[50rem] md:text-lg md:mx-10 text-center mt-10'>
                    Otroci so za posamezne dosežke na področju karateja,
                    gibalnih in socialnih veščin ter naravi prijaznih navad
                    nagrajeni z »Zmajskimi karticami« in točkami v albumu Kako
                    postanem Zmajski bojevnik. Glavni namen albuma je, da
                    otrokom na privlačen in enostaven način pomaga osmisliti
                    namen in pomen vadbe v Prijazni šoli karateja. Za otroke
                    poleg rednih letnih izpitov za karate pasove organiziramo
                    tudi redna letna testiranja gibalnih sposobnosti, mesečne
                    aktivnosti za izboljšanje in spoznavanje posameznih gibalnih
                    ter socialnih veščin ter Zmajčkovo tekmovanje v treh
                    disciplinah. Starši in otroci lahko svojim dosežkom sledijo
                    preko svojega profila na platformi Moje spretnosti, ki
                    vsebuje izobraževalne programe, video vsebine, rezultate
                    testiranj, evidence opravljenih nalog in omogoča učinkovito
                    komunikacijo med udeleženci programa ter njihovimi trenerji.
                  </p>
                ...
                <div className='flex 2xl:flex-row flex-col'>
                  ...
                  <div className='md:mt-10 flex flex-col items-center 2xl:block  animate-fade-right animate-duration-1000 animate-delay-1000'>
                    <p className='max-w-[50rem] md:text-lg md:mx-10 text-center'>
                      ...
                      za črni pas, kjer morajo predstaviti kompleksno tehnično
                      in borbeno znanje karateja. Program je smiselno
                      nadaljevanje programa Prijazna šola karateja, lahko pa se
                      mu priključijo tudi mladostniki, ki z vadbo karateja
                      začnejo kasneje. Vadeči so vključeni v redna letna
                      testiranja gibalnih sposobnosti, tekmujejo lahko na
                      regionalnih tekmovanjih, učijo se samoobrambnih elementov
                      in tehnik. Podobno kot pri Prijazni šoli karateja,
                      mladostnike motiviramo za delo v klubu in šoli s pomočjo
                      motivacijske igre. Motivacijska igra JOKER smiselno
                      ...
                      karateju. Jokerja je mogoče osvojiti z dobrimi ocenami v
                      šoli, dobrimi rezultati na testiranju gibalnih sposobnosti
                      ali s pomočjo na treningih in tekmovanjih
                    </p>
                    <div className='flex flex-col md:flex-row items-center justify-center'>
                      <div className='text-center max-w-[40rem] pt-10'>
                        <div className='text-xl mb-7 underline'>
                        ...
                        <ul>
                          ...
                          <p className='mb-5 md:text-lg'>
                            Vadba karateja je odličen način za krepitev
                            samozavesti pri otrocih in mladostnikih.
                            Sistematično učenje novih tehnik in premagovanje
                            izzivov na treningih prispeva k občutku dosežkov,
                          ...
                          <p className='mb-5 md:text-lg'>
                            Karate ni le šport, temveč tudi učinkovita metoda
                            samoobrambe. Otroci se učijo različnih tehnik, ki
                            jim lahko pomagajo v primeru morebitnih neprijetnih
                            situacij. Razvijanje teh spretnosti povečuje
                            otrokovo občutje varnosti in mu daje znanje, kako se
                            zaščititi pred medvrstniškim nasiljem.
                          </p>
                          <li className='mb-5 text-lg font-semibold'>
                            VADBA ZA CELOTNO TELO
                          </li>
                          <p className='mb-5 md:text-lg'>
                            ...
                            gibljivost in koordinacijo. Redna vadba karateja
                            spodbuja zdrav življenjski slog in prispeva k
                            celostnemu fizičnemu razvoju. Zaradi kompleksnih
                            gibov in pestrega nabora vaj, ki so vključene v
                            vadbeni proces, pa prestavlja tudi zelo dobro osnovo
                            za kasnejše vključevanje v druge športe.
                          </p>
                          <li className='mb-5 text-lg font-semibold'>
                            SOCIALNE VEŠČINE IN EKIPNO DELO
                          </li>
                          <p className='mb-5 md:text-lg'>
                            ...
                            vrstniki. Skupaj s treningi se učijo tudi o pomenu
                            spoštovanja, discipline, urejenosti, sodelovanja in
                            ekipnega dela. To prispeva k razvoju socialnih
                            veščin, ki so pomembne za uspešno interakcijo v
                ...
                <div className='flex 2xl:flex-row flex-col'>
                  ...
                  <div className='md:mt-10 flex flex-col items-center 2xl:block  animate-fade-right animate-duration-1000 animate-delay-1000'>
                    <p className='max-w-[50rem] md:text-lg md:mx-10 text-center'>
                      ...
                      programa je oblikovana na osnovi naših dolgoletnih
                      izkušenj s področja poučevanja in raziskovanja borilnih
                      veščin in drugih telesnih tehnik. Vadba učinkuje na boljšo
                      fizično pripravljenost, boljšo aerobno in anaerobno
                      vzdržljivost, povečanje naše gibljivosti, izboljšanje
                      drže, odpravo kroničnih mišičnih napetosti in bolečin,
                      izboljšanje pozornosti in boljše soočanje s stresnimi
                      situacijami. Vadba je primerna za vse starosti, za moške
                      in ženske. Vsebuje raztezne vaje, vaje za moč, izvajanje
                      karate elementov, ki nam pomagajo pri izboljšanju
                      motorične kontrole nad našim telesom. Na osnovi daljših
                      borbenih zaporedij – kat, izboljšamo našo orientacijo v
                      prostoru. S pomočjo nekontaktne borbe pa se učimo
                      prepoznavati naše odzive ter ohranjati mirnost in
                      osredotočenost tudi v stresnih situacijah. Vadeči lahko
                      opravljajo izpite za pasove in v 5 do 6 letih opravijo
                      izpit za črni pas, ki je lahko dodaten motivacijski faktor
                      za vadbo. Udeležijo se lahko tudi testiranj gibalnih
                      sposobnosti, s katerimi lahko preverijo svojo trenutno
                      ...
                      <div className='text-center max-w-[40rem] pt-10'>
                        ...
                        <ul>
                          ...
                          <p className='mb-5 md:text-lg'>
                            ...
                            uma pripomorejo k večji samozavesti in lažjem
                            soočanju s stresnimi situacijami v vsakdanjem
                            življenju.
                          </p>
                          <li className='mb-5 text-lg font-semibold md:text-lg'>
                            SPRETNOSTI SAMOOBRAMBE
                          ...
                          <p className='mb-5 md:text-lg'>
                            ...
                            elementov vsebuje tudi učinkovite metode
                            samoobrambe. Med vadbo se naučimo različnih tehnik,
                            ki nam lahko pomagajo v morebitnih neprijetnih
                            situacijah. Razvijanje teh spretnosti povečuje vaše
                            občutje varnosti in vam daje znanje, kako se
                            zaščititi.
                          </p>
                          <li className='mb-5 text-lg font-semibold'>
